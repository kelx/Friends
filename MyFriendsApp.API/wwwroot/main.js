    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
                ...
                //       if (badRequest[key]) {
                //         badRequestError += badRequest[key] + '\n';
                //       }
                //     }
                //   }
...
/* harmony import */ var _members_photo_edit_photo_editor_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./members/photo-edit/photo-editor.component */ "./src/app/members/photo-edit/photo-editor.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _members_photo_edit_photo_editor_component__WEBPACK_IMPORTED_MODULE_29__["PhotoEditorComponent"],
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        ...
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function () {
            _this.alertify.success('You have successfully liked: ' + _this.user.knownAs);
        }, function (error) {
            _this.alertify.error(error);
        });
    };
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.ngOnInit = function () {
        ...
        this.route.data.subscribe(function (data) {
            _this.user = data['user'];
            _this.authService.currentPhotoUrl.subscribe(function (pUrl) { return _this.photoUrl = pUrl; });
        });
    };
...
var MemberListComponent = /** @class */ (function () {
    function MemberListComponent(userService, route, alertify) {
        this.userService = userService;
        this.route = route;
        this.alertify = alertify;
    ...
    MemberListComponent.prototype.ngOnInit = function () {
        ...
        this.userParams.orderyBy = 'lastActive';
    };
        ...
        this.userService.getMessageThread(this.authService.decodedToken.nameid, this.recipientId)
            ...
            for (var i = 0; i < messages.length; i++) {
                if (messages[i].isRead === false && messages[i].recipientId === currentUserId) {
                    _this.userService.markMessageAsRead(currentUserId, messages[i].id);
                }
            }
        }))
...
/***/ "./src/app/members/photo-edit/photo-editor.component.css":
/*!***************************************************************!*\
  !*** ./src/app/members/photo-edit/photo-editor.component.css ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/members/photo-edit/photo-editor.component.html":
/*!****************************************************************!*\
  !*** ./src/app/members/photo-edit/photo-editor.component.html ***!
  \****************************************************************/
/*! no static exports found */
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.InitializeUploader = function () {
        ...
        this.uploader.onAfterAddingFile = function (kfile) {
    ...
    PhotoEditorComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./photo-editor.component.html */ "./src/app/members/photo-edit/photo-editor.component.html"),
            styles: [__webpack_require__(/*! ./photo-editor.component.css */ "./src/app/members/photo-edit/photo-editor.component.css")]
        }),
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.photoUrl.subscribe(function (pUrl) { return _this.photoUrl = pUrl; });
    };
...
module.exports = __webpack_require__(/*! E:\user\kel\My Projects\Angular\MyFriendsapp\myfriendsapp-spa\src\main.ts */"./src/main.ts");
